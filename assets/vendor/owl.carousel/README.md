...
```html
<link rel="stylesheet" href="index.htmlnode_modules/owl.carousel/dist/assets/owl.carousel.min.css" />
```

```html
<link rel="stylesheet" href="index.htmlbower_components/owl.carousel/dist/assets/owl.carousel.min.css" />
```
